...
endRefreshing:function(){function endRefreshing(reactTag){

}return endRefreshing;}(),
scrollTo:function(){function scrollTo(reactTag,offset,animated){

}return scrollTo;}(),
zoomToRect:function(){function zoomToRect(reactTag,rect,animated){
