...
return _ImagePickerIOS2['default'].openCameraDialog(newConfig,successCallback,cancelCallback);
...
return _ImagePickerIOS2['default'].openSelectDialog(newConfig,successCallback,cancelCallback);
